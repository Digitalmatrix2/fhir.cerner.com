...
* RelatedPerson.relationship codes are maintained in [Code Set 351 Person Relationship Types](#code-set-351-person-relationship-types) and [Code Set 40 Person     Relationhip Types](#code-set-40-person-relationship)
